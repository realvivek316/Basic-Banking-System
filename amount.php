...
$row2=$res2->fetch_row();
   ...
   if($amt > $row1['5'])
  {
   ...
   else
    {
       ...
       $sac = $row1['1'];
       $rac = $row2['1'];
       $linknew=new mysqli("localhost","root","","nags") or die("DATA NOT FOUND");
...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    .msg
 {
  ...
  <?php
  $link1=new mysqli("localhost","root","","nags") or die("DATA NOT FOUND");
  ...
  $link2=new mysqli("localhost","root","","nags") or die("DATA NOT FOUND");
