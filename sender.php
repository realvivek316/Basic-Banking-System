...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg mb-3">
    ...
    <a href="#" class="navbar-brand">
      <!-- Logo Image -->
      <img src="https://png.pngtree.com/png-clipart/20190630/original/pngtree-vector-bank-icon-png-image_4173791.jpg" height="100px" width="100" alt="" class="d-inline-block align-left mr-2">
      <!-- Logo Text -->
